...
my $proxysql_default_hostgroup = 10; # set to writer hostgroup ID
  ...
  my $hooks = [
    {
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::create_proxysql_default_user',
      'exectype' => 'module',
    },
    {
      'category' => 'Whostmgr',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::remove_proxysql_default_user',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::create_proxysql_user',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::create_proxysql_user2',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::delete_proxysql_user',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::delete_proxysql_user2',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::set_default_schema',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::set_default_schema2',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::rename_proxysql_user',
      'exectype' => 'module',
    },
    {
      'category' => 'Cpanel',
      ...
      'stage'    => 'post',
      'hook'     => 'ProxysqlHook::set_mysql_user_password',
      'exectype' => 'module',
    }
  ];
  return $hooks;
